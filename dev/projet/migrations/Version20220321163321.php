 ...
 */
final class Version20220321163321 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE constelation (id INT NOT NULL, code_constelation VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, saison VARCHAR(255) DEFAULT NULL, etoile_principale VARCHAR(255) DEFAULT NULL, image VARCHAR(1000) DEFAULT NULL, date_debut DATE DEFAULT NULL, date_fin DATE DEFAULT NULL, PRIMARY KEY(id))');
